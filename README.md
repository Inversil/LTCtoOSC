...
- The audio of the video is not streamed from touch designer into Ableton Live, so you need to manually extract and import the video audio if you want to edit it in your project. If you have an MP4 video, this should only take a few clicks in Audacity, Audition, or Resonic Pro.
